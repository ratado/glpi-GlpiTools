...
function Get-GlpiToolsAppsStructuresComponentTarget {
    ...
    begin {
        ...
        $ComponentTargetsArray = [System.Collections.Generic.List[PSObject]]::New()
    }
    ...
    process {
        switch ($ChoosenParam) {
            All {
                ...
                $GlpiComponentTargetAll = Invoke-GlpiToolsRequestApi -Params $params -Verbose:$false
                ...
                foreach ($GlpiComponentTarget in $GlpiComponentTargetAll) {
                    ...
                    $ComponentTargetsArray.Add($object)
                }
