...
function Get-GlpiToolsAppsStructuresComponentInstance {
    ...
    begin {
        ...
        $ComponentInstanceArray = [System.Collections.Generic.List[PSObject]]::New()
    }
    ...
    process {
        switch ($ChoosenParam) {
            All {
                ...
                $GlpiComponentInstanceAll = Invoke-GlpiToolsRequestApi -Params $params -Verbose:$false
                ...
                foreach ($GlpiComponentInstance in $GlpiComponentInstanceAll) {
                    ...
                    $ComponentInstanceArray.Add($object)
                }
